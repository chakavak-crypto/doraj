...
import OrderTypeSwitch from "@/features/OrderCard/OrderTypeSwitch";

export default function SellCryptoCard(props: OrderCardProps) {
        ...
        <Stack spacing={2}>
          ...
          <Box>
            ...
            <CkkCurrencyFieldType1
              ...
              defaultValue={Boolean(props.volume) ? props.volume : null}
              hasSlider
